...
test_that("We geta warning when there is no url", {
    expect_warning(get_list_repos_org(org = org, api_key = api_key),
                   "Please add a valid URL")
})

test_that("We geta warning when there is no api_key", {
    expect_warning(get_list_repos_org(org = org, base_url = base_url),
                   "Please add a valid API token")
})

test_that("We geta warning when there is no name of organization", {
    expect_warning(get_list_repos_org(base_url = base_url, api_key = api_key),
